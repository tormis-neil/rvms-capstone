...
EDGES = []
def add(pts, one_end, many_end): EDGES.append((pts, one_end, many_end))
...
add([(a['r'], a['y']+40), (u['x'], a['y']+40)],
    ('h', a['r'], a['y']+40, 1), ('h', u['x'], a['y']+40, -1))

TOPLANE = 96
add([(a['cx']+70, a['y']), (a['cx']+70, TOPLANE), (v['cx'], TOPLANE), (v['cx'], v['y'])],
    ('v', a['cx']+70, a['y'], -1), ('v', v['cx'], v['y'], 1))

n = B("notifications")
add([(a['cx']-95, a['b']), (a['cx']-95, n['y'])],
    ('v', a['cx']-95, a['b'], 1), ('v', a['cx']-95, n['y'], -1))
