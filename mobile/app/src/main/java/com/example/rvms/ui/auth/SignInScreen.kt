...
fun SignInScreen(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            // Reveal toggle (NFR-03, 2026-09): lets a driver confirm what they
            // typed, cutting sign-in lockouts. Text button avoids adding the
            // material-icons-extended dependency; swap for an eye glyph if added.
            trailingIcon = {
